...
function testConcreteFactory(\Interfaces\AbstractBookFactory $bookFactoryInstance)
{
...
writeln('');
$bookFactoryInstance = new \Factory\OReillyBookFactory();
testConcreteFactory($bookFactoryInstance);
writeln('');

writeln('testing SamsBookFactory');
writeln('');
$bookFactoryInstance = new \Factory\SamsBookFactory();
testConcreteFactory($bookFactoryInstance);
